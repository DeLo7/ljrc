...
def drew_tk():
    ...
    sca = tkinter.Scale(root, from_=10, to=100, orient=tkinter.HORIZONTAL, length=100,
                        showvalue=60, resolution=0.1, tickinterval=50, command=SetScale)
    ...
    sca.set(100)
    clientIp = config.get("active", "clientip")
    val.set(clientIp+':777')
